...
rm -f esercizio*b.sh esercizio*c.sh esercizio*d.sh
...
rm -f esercizio*a.sh esercizio*c.sh esercizio*d.sh
...
rm -f esercizio*a.sh esercizio*b.sh esercizio*d.sh
...
rm -f esercizio*a.sh esercizio*b.sh esercizio*c.sh
...
chmod +x tracciaA.sh tracciaB.sh tracciaC.sh tracciaD.sh
...
echo "  ./tracciaA.sh  oppure  ./tracciaB.sh  oppure  ./tracciaC.sh  oppure  ./tracciaD.sh"
